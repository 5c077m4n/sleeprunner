...
struct AppConfig: Codable {
	...
	init(from decoder: Decoder) throws {
		...
		idleThresholdSeconds =
			try container.decodeIfPresent(TimeInterval.self, forKey: .idleThresholdSeconds) ?? 300.0
		idleCheckInterval =
			try container.decodeIfPresent(TimeInterval.self, forKey: .idleCheckInterval) ?? 60.0
	}
